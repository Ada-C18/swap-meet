...
# - `Vendor`s have a method named `swap_best_by_category`, 
...
#   - The best item in my inventory that matches `their_priority` category is 
#      swapped with the best item in `other`'s inventory that matches `my_priority`
#     - It returns `True`
