...
def test_integration_wave_04_05_06():
    ...
    item_clothing1 = Clothing(condition=1.0,age=1.0)
    item_clothing2 = Clothing(condition=2.0,age=2.0)
    item_electronics1 = Electronics(condition=1.0,age=1.0)
    item_electronics2 = Electronics(condition=2.0,age=2.0)
    item_decor1 = Decor(condition=1.0,age=1.0)
    item_decor2 = Decor(condition=2.0,age=2.0)
    ...
    result = camila.swap_by_newest(valentina, "Clothing", "Clothing")
