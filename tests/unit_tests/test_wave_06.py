...
def test_swap_best_by_category():
    ...
    tai_new_inventory = [item_a, item_b, item_f]
    jesse_new_inventory = [item_c, item_d, item_e]
    ...
    # tai should have a, b, f and jesse should have c, d, e
...
def test_swap_best_by_category_no_match_is_false():
    ...
    tai_copy = [item_a, item_b, item_c]
    jesse_copy = [item_d, item_e, item_f]
    ...
    for item in jesse_copy:
        assert item in jesse.inventory
    for item in tai_copy:
        assert item in tai.inventory
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    tai_copy = [item_c, item_b, item_a]
    jesse_copy = [item_f, item_e, item_d]
