...
def test_swap_best_by_category():
    ...
    assert all(item in tai.inventory for item in [item_a, item_b, item_f]) and all(item in jesse.inventory for item in [item_d, item_e, item_c])
...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert not result
    assert len(tai.inventory) == 3 and len(jesse.inventory) == 3
    assert all(item in tai.inventory for item in [item_a, item_b, item_c]) and all(item in jesse.inventory for item in [item_d, item_e, item_f])
