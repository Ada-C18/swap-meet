...
def test_swap_best_by_category():
    ...
    assert result == True
    # assert tai.get_best_by_category.category == "Clothing"
    # assert tai.get_best_by_category.condition == pytest.approx(4.0)
    # assert jesse.get_best_by_category.category == "Decor"
    # assert jesse.get_best_by_category.condition == pytest.approx(4.0)
